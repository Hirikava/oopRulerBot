...
{
    Task<SendVerificationStatus> SendVerification(ulong discordGuildId, ulong discordRoleId, ulong discordUserId, IReadOnlyDictionary<string, string> identifiers);
